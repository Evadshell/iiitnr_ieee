    ...
    >
      {slides.map((slide, index) => (
        <SplideSlide key={index}>
          <div className={`relative h-[500px] w-full bg-gradient-to-r ${slide.bgColor}`}>
            <div 
            ...
            />
            <div className="container relative flex h-full flex-col items-start justify-center py-20 text-white">
              <h2 className="mb-6 text-5xl font-bold tracking-tight">{slide.title}</h2>
              <p className="mb-10 text-2xl font-light">{slide.subtitle}</p>
              <Button 
                size="lg" 
                variant="secondary"
